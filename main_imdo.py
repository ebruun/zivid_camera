...
def main_clean_pcd(pcd_range, test_name, folder_names, file_names, vis_on=False):
    pcd_stitch_and_crop(pcd_range, test_name, folder_names, file_names, vis_on)

def main_isolate_pcd(pcd_range, test_name, folder_names, file_names, vis_on=False):
...
if __name__ == "__main__":
    ...
    # main_clean_pcd(range(0, 29), test_name, folder_names, file_names, vis_on=True)
    main_isolate_pcd(range(7, 8), test_name, folder_names, file_names, vis_on=True)
