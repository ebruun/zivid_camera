...
data_file_in = create_file_path("input","lab_test_april20.zdf")
#data_file_in = create_file_path("input","MiscObjects.zdf")

file_out_bgr = create_file_path("output","may23_image.png")
file_out_depth = create_file_path("output","may23_depth.png")
